...
| --- | --- | --- |
| Accessing the status line | <pre><code>getViewSite()<br>   .getActionsBars()<br>     .getStatusLineManager()<br>    .setMessage(msg);</code></pre> |   @Inject IStatusLineManager statusLine; ... statusLine.setMessage(msg);             @Inject     IStatusLineManager statusLine;     ...     statusLine.setMessage(msg);           |

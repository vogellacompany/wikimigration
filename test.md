...
| --- | --- | --- |
| Accessing the status line | <pre>getViewSite()<br>   .getActionsBars()<br>     .getStatusLineManager()<br>    .setMessage(msg);</pre> |   @Inject IStatusLineManager statusLine; ... statusLine.setMessage(msg);             @Inject     IStatusLineManager statusLine;     ...     statusLine.setMessage(msg);           |

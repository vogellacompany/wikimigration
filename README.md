...
*   [API](/Category:API "Category:API")
*   [Best Practices](/Category:Best_Practices "Category:Best Practices")
*   [Eclipse Platform Releng](/Category:Eclipse_Platform_Releng "Category:Eclipse Platform Releng")

Retrieved from "[https://wiki.eclipse.org/index.php?title=Version_Numbering&oldid=433094](https://wiki.eclipse.org/index.php?title=Version_Numbering&oldid=433094)"

This page was last modified 03:00, 25 June 2019 by [Andrey Loskutov](/index.php?title=User:Loskutov.gmx.de&action=edit&redlink=1 "User:Loskutov.gmx.de (page does not exist)"). Based on work by [Nitin Dahyabhai](/index.php?title=User:Nitind.pobox.com&action=edit&redlink=1 "User:Nitind.pobox.com (page does not exist)"), [Dani Megert](/User:Daniel_Megert.ch.ibm.com "User:Daniel Megert.ch.ibm.com") and [Markus Keller](/User:Markus_keller.ch.ibm.com "User:Markus keller.ch.ibm.com") and [others](/index.php?title=Version_Numbering&action=credits "Version Numbering").
...
*   [About Us](https://www.eclipse.org/org/)
*   [Contact Us](https://www.eclipse.org/org/foundation/contact.php)
*   [Donate](https://www.eclipse.org/donate)
*   [Members](https://www.eclipse.org/membership/)
*   [Governance](https://www.eclipse.org/org/documents/)
*   [Code of Conduct](https://www.eclipse.org/org/documents/Community_Code_of_Conduct.php)
*   [Logo and Artwork](https://www.eclipse.org/artwork/)
*   [Board of Directors](https://www.eclipse.org/org/foundation/directors.php)
...
*   [Marketplace](//marketplace.eclipse.org)

Other
-----

*   [IDE and Tools](https://www.eclipse.org/ide/)
*   [Projects](https://www.eclipse.org/projects)
*   [Working Groups](https://www.eclipse.org/org/workinggroups/)
*   [Research@Eclipse](https://www.eclipse.org/org/research/)
